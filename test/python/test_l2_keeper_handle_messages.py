...
class L2KeeperTickTests(unittest.TestCase):
    def _runtime(self, *, state_file: Path, signer: Mock | None) -> L2KeeperRuntime:
        return L2KeeperRuntime(
            ...
            loan_store_addr="0x1212121212121212121212121212121212121212",
            option_asset="0x3434343434343434343434343434343434343434",
            subaccount_id=55,
    ...
    def _local_atomic_runtime(self, *, state_file: Path, signer: Mock | None) -> L2KeeperRuntime:
        ...
        return L2KeeperRuntime(
            ...
            loan_store_addr=runtime.loan_store_addr,
            option_asset=runtime.option_asset,
            subaccount_id=runtime.subaccount_id,
